...
export class ExtendedColor {
  ...
  static lightest(color1: RgbObject|ExtendedColor, color2: RgbObject|ExtendedColor) {
    return ExtendedColor.luminance(color1) >= ExtendedColor.luminance(color2) ? color1 : color2; 
  }
  ...
  contrast(targetRatio: number) {
    ...
    contrast.lightOnDark.style = {
      backgroundColor: contrast.lightOnDark.background.hex(),
      color: contrast.lightOnDark.foreground.hex(),
    }

    contrast.darkOnLight.style = {
      backgroundColor: contrast.darkOnLight.background.hex(),
      color: contrast.darkOnLight.foreground.hex(),
    }
  ...
  //   return new ExtendedColor(this.color.whiten(amount));
  // }
  // blacken(amount: number) {
  //   return new ExtendedColor(this.color.blacken(amount));
  // }
