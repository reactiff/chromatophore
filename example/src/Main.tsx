...
// import chameleon from './chameleon.jpg';
...
const App = () => {
  ...
  const refPic = React.createRef<HTMLImageElement>();
  ...
  // rotate chameleon hue
  const hue = useRef({ degrees: 0 }).current;
  useEffect(() => {
    if (!refPic.current) return;
    const rotate = () => {
      refPic.current!.style.filter = `hue-rotate(${hue.degrees}deg)`;
      hue.degrees = (hue.degrees + 1) % 360;
  ...
  return <div className="background" style={style.background}>
    ...
    <div className="container" style={style.container} >
      ...
      <div className="content" style={style.content}>
        ...
        <img ref={refPic} src={'/chameleon.jpg'} alt="chameleon" />
